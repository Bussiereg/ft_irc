...
# gnome-terminal -- bash -c "irssi -n Kevain -c localhost -p 6669 -w pw"
# gnome-terminal -- bash -c "irssi -n Kevian -c localhost -p 6669 -w pw"
# gnome-terminal -- bash -c "irssi -n Kevifn -c localhost -p 6669 -w pw"
# gnome-terminal -- bash -c "irssi -n Kehvin -c localhost -p 6669 -w pw"
# gnome-terminal -- bash -c "irssi -n Kejvin -c localhost -p 6669 -w pw"
# gnome-terminal -- bash -c "irssi -n Kevkin -c localhost -p 6669 -w pw"
